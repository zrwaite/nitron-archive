...
impl NpcAnimator {
    pub fn new() -> Self {
        ...
        NpcAnimator {
            ...
            up_frames: NpcAnimator::get_animation_frame(top_left_frame, Direction::Up),
            down_frames: NpcAnimator::get_animation_frame(top_left_frame, Direction::Down),
            left_frames: NpcAnimator::get_animation_frame(top_left_frame, Direction::Left),
            right_frames: NpcAnimator::get_animation_frame(top_left_frame, Direction::Right),
            current_timer: 0,
            max_timer: 8,
        }
    }
    fn get_animation_frame(top_left_frame: Rect, direction: Direction) -> Vec<Rect> {
        ...
        let y_offset = top_left_frame.y() + frame_height as i32 * NpcAnimator::direction_spritesheet_row(direction);
